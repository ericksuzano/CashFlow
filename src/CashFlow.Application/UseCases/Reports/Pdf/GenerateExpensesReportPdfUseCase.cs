...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Title = $"{ResourceReportGenerationMessages.EXPENSES_FOR} {month:Y}"; // string interpolation
        document.Info.Author = "Erick Correia";
    ...
    private void CreateHeaderWithProfilePictureAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "download.png");
